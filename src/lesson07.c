/*
=====================================================================
OpenGL Lesson 07 :  Creating Another OpenGL Window with glut on Linux
=====================================================================
...
* \version         2.0.1.0
* \date            25 mars 2023
* \brief           Ouvre une simple fenêtre Wayland on Linux et dessine un cube dont les faces proviennent d'une texture issue d'un fichier BMP avec OpenGL + glut.
...
* \details                                                  les touches "f" ou "F" qui active ou non le "Full Screen".
*
*
*/
...
void keyPressed(unsigned char key, int x, int y)
{
	...
	//Quitter
        ...
        case 'i': // switch the filter.
            printf("I/i pressed; filter is: %d\n", filter);
            filter+=1;
            if (filter>2) {
                filter=0;
            }
...
*/
    ...
    window = glutCreateWindow("Jeff Molofee's GL Tutorial : draw cube in rotation with faces textured (issued BMP) - NeHe '99");
